...
{	
	...
	cout <<"This is the average time for each shell sort  " << newtotal << "." << endl;//the average runtime of each shell sort
	// int stupid = 0;
	// cin >> stupid;
	return 0;
...
void shellSortParallel(int array[], int length)
{
	...
	for(h =length/2; h > 0; h = h/2)
	{
		...
		#pragma omp parallel for shared( array, length, h, i,threads)  default(none)
		for( i = 0; i < h; i++)
		{
